...
3. Change detection is incremental:
   - Default (`auto`): adaptive, jittered Git polling first for Git worktrees (including linked/isolated worktrees), with a recursive filesystem watcher only as fallback
