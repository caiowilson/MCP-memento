...
func TestHandleCLICommandPrintGuidance(t *testing.T) {
	...
	if !strings.Contains(stdout.String(), "repo_context") || !strings.Contains(stdout.String(), "repo_outline") || !strings.Contains(stdout.String(), "Anchor durable notes") || !strings.Contains(stdout.String(), "intent") {
