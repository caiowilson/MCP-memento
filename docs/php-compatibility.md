...
1. Preserve the post-terms-v13 membership-freeze-cause miss, then generalize authoritative domain-declaration and allowed-code vocabulary without promoting security-token sets or consumer requests.
