...
1. Preserve the post-terms-v11 every-domain singular-spelling miss, then generalize the enum-header boundary using structural evidence that does not weaken serializer and presenter negative controls.
