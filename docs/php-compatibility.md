...
1. Preserve the post-terms-v12 authoritative stored-token miss, then generalize serialized-domain value vocabulary without weakening serializer and presenter negative controls.
