...
1. Preserve the post-terms-v14 cold-chain excursion-disposition miss, then generalize `permitted` closed-set and disposition-domain vocabulary without promoting configuration, security-token, or consumer requests.
