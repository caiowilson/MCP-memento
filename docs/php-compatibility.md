...
1. Preserve the post-terms-v10 durable-catalog-spelling miss, then evaluate representation and closed-set synonym expansion on a separately fingerprinted scorer without weakening consumer negative controls.
